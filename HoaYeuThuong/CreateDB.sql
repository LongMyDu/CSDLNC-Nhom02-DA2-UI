...
CREATE TABLE NHANVIEN (
  ...
  CHINHANHMaCN       int NOT NULL, 
  LOAINHANVIENMaLNV  int NOT NULL, 
  PRIMARY KEY (MaNV));
CREATE TABLE LOAINHANVIEN (
  MaLNV  int IDENTITY NOT NULL, 
  TenLNV nvarchar(20) NULL, 
  PRIMARY KEY (MaLNV));
...
CREATE TABLE HOATUOI (
  ...
  MAUSACMaMau   int NOT NULL, 
  TenHT         nvarchar(20) NULL, 
...
CREATE TABLE SANPHAMQUATANG (
  ...
  GiaBan        bigint NULL, 
  CHUDEMaCD     int NOT NULL, 
  TenSPQT       nvarchar(20) NULL, 
...
CREATE TABLE SANPHAMMUAKEM (
  ...
  TenSPMK    nvarchar(20) NULL, 
  MieuTaSPMK nvarchar(100) NULL, 
  GiaBan     bigint NULL, 
  DOITACMaDT int NOT NULL, 
  PRIMARY KEY (MaSPMK));
...
CREATE TABLE MUA_SPQT (
  ...
  DonGia               bigint NULL, 
  SoLuong              int NULL, 
  PRIMARY KEY (SANPHAMQUATANGMaSPQT, 
  DONDATHANGMaDDH));
